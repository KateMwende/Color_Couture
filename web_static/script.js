const app = Vue.createApp({
  ...
  methods: {
    handleSubmit(event) {
      ...
      // Assuming this.date is in the format 'DD-MM-YYYY'
      const parsedDate = moment(this.date, 'DD-MM-YYYY', true); // 'true' is used for strict parsing

      if (parsedDate.isValid()) {
        const formattedDate = parsedDate.format('YYYY-MM-DD');
        // Now 'formattedDate' contains the correctly formatted date
